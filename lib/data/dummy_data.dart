...
const availableCategories = {
  ...
  CategoryModel(id: 'c2', title: 'Quick and easy', color: Colors.red),
  CategoryModel(id: 'c3', title: 'Hamburgers', color: Colors.orange),
  CategoryModel(id: 'c4', title: 'German', color: Colors.amber),
  CategoryModel(id: 'c5', title: 'Light and lovely', color: Colors.blue),
  CategoryModel(id: 'c6', title: 'Exotic', color: Colors.green),
  CategoryModel(id: 'c7', title: 'Break fast', color: Colors.lightBlue),
